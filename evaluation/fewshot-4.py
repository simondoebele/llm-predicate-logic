...
def make_predictions(dataset, model, tokenizer):
    predictions = []
    for datapoint in dataset["FewShot-4"]:
...
task1_dataset = pd.read_json('Task1-fs4-dataset.json')
...
task2_dataset = pd.read_json('Task2-fs4-dataset.json')
...
task3_dataset = pd.read_json('Task3-fs4-dataset.json')
...
save_task1_to_json(task1_dataset, predictions, "flan-ul2_task1-fs4.json")

# Task 2
predictions = make_predictions(task2_dataset, model, tokenizer)
save_task2_to_json(task2_dataset, predictions, "flan-ul2_task2-fs4.json")

# Task 3
predictions = make_predictions(task3_dataset, model, tokenizer)
save_task3_to_json(task3_dataset, predictions, "flan-ul2_task3-fs4.json")
...
save_task1_to_json(task1_dataset, predictions, "falcon-7b_task1-fs4.json")

# Task 2
predictions = make_predictions_CausalLM(task2_dataset, model, tokenizer)
save_task2_to_json(task2_dataset, predictions, "falcon-7b_task2-fs4.json")

# Task 3
predictions = make_predictions_CausalLM(task3_dataset, model, tokenizer)
save_task3_to_json(task3_dataset, predictions, "falcon-7b_task3-fs4.json")
...
# Task 1
predictions = make_predictions_CausalLM(task1_dataset, model, tokenizer)
save_task1_to_json(task1_dataset, predictions, "Llama-2-13b-chat-hf_task1-fs4.json")

# Task 2
predictions = make_predictions_CausalLM(task2_dataset, model, tokenizer)
save_task2_to_json(task2_dataset, predictions, "Llama-2-13b-chat-hf_task2-fs4.json")

# Task 3
predictions = make_predictions_CausalLM(task3_dataset, model, tokenizer)
save_task3_to_json(task3_dataset, predictions, "Llama-2-13b-chat-hf_task3-fs4.json")
